<template>
  <UiBlockContainer class="bg-muted/30">
    <div class="container mx-auto px-4 md:px-6">
      ...
      <div class="max-w-3xl mx-auto space-y-4">
        <div
            ...
            :key="index"
            class="bg-background border border-border rounded-lg shadow-sm transition-all duration-200"
            :class="openIndex === index ? 'ring-2 ring-primary border-transparent' : 'hover:border-primary/50'"
        >
          <h3>
            <button
