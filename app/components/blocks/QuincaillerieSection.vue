  ...
  <section id="quincaillerie" class="py-12 md:py-16 bg-background">
    <div class="container mx-auto px-4">
      <UiSectionHeader
          ...
          title="Votre nouvelle quincaillerie à La Réunion"
          subtitle="Découvrez notre large gamme de produits pour tous vos projets de construction, rénovation et aménagement."
      />
