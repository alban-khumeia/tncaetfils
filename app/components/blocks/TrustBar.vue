<template>
  <section class="bg-secondary text-white min-h-[16vh] flex items-center justify-center py-8 lg:py-0">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
        <div v-for="(feature, index) in features" :key="index"
             class="flex flex-col items-center text-center gap-2 justify-center">
